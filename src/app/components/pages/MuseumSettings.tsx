...
const team = [
  {
    name: "Eng. Mohamed Abdelsattar",
    role: "Museum Director",
    email: "dr.hassan@gem.gov.eg",
    status: "Admin",
  },
  {
    name: "Fatima El-Sayed",
    role: "Head of Digital",
    email: "f.elsayed@gem.gov.eg",
    status: "Admin",
  },
  {
    name: "Omar Khalil",
    role: "Curator, Ancient Egypt",
    email: "o.khalil@gem.gov.eg",
    status: "Editor",
  },
  {
    name: "Nour Abdel-Rahim",
    role: "Analytics Lead",
    email: "n.abdelrahim@gem.gov.eg",
    status: "Viewer",
  },
  {
    name: "Sara Mansour",
    role: "Marketing Manager",
    email: "s.mansour@gem.gov.eg",
    status: "Editor",
  },
];
...
const settingsSections = [
  {
    ...
    desc: "Configure alerts for performance thresholds, content flags, and weekly digests",
  },
  {
    icon: Shield,
    label: "Privacy & Data Settings",
    desc: "Manage data retention, anonymization, and visitor consent policies",
  },
  {
    icon: Link,
    label: "Integration & Content Sync",
    desc: "Connect artifact databases, CMS, and third-party analytics platforms",
  },
];
  ...
  return (
    <div className="w-full max-w-[1400px] space-y-6">
      <div>
        ...
        <p className="text-[#a89279] text-[13px] mt-0.5">
          Institutional configuration and account management
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-[#efe9df]">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              <label className="text-[#a89279] text-[11px] uppercase tracking-[1px] block mb-1">
                Museum Name
              </label>
              <div className="text-[#341701] text-[14px] bg-[#faf8f3] px-4 py-2.5 rounded-xl">
            ...
            <div>
              ...
              <div className="text-[#341701] text-[14px] bg-[#faf8f3] px-4 py-2.5 rounded-xl">
                Al Remaya Square, Giza, Cairo, Egypt
              </div>
            </div>
            <div>
              <label className="text-[#a89279] text-[11px] uppercase tracking-[1px] block mb-1">
              ...
              <div className="text-[#341701] text-[14px] bg-[#faf8f3] px-4 py-2.5 rounded-xl">
                9:00 AM – 6:00 PM (Sat–Thu) · Closed Friday
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              <label className="text-[#a89279] text-[11px] uppercase tracking-[1px] block mb-1">
                MuseoVerse Partner ID
              </label>
              <div className="text-[#341701] text-[14px] bg-[#faf8f3] px-4 py-2.5 rounded-xl font-mono">
                MV-GEM-2024-0001
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center gap-2 bg-[#faf8f3] px-4 py-2.5 rounded-xl">
                ...
                <span className="text-[#341701] text-[14px]">
                  Active — Premium Plan
                </span>
              </div>
            </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-[#efe9df]">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="px-3 py-1.5 bg-[#faf5eb] text-[#c9a84c] text-[12px] rounded-lg">
            + Add Zone
          </button>
        </div>
          ...
          {halls.map((h) => (
            ...
            >
              <div>
                ...
                <div className="text-[#a89279] text-[11px]">
                  {h.artifacts} artifacts
                </div>
              </div>
              <span
                className={`text-[10px] px-2 py-0.5 rounded-full ${h.status === "Active" ? "bg-[#e8f5ec] text-[#3a7d4f]" : "bg-[#f0ebe3] text-[#76593a]"}`}
              >
                {h.status}
              </span>
            </div>
        ...
        <table className="w-full text-[13px]">
          ...
          <tbody>
            {team.map((t) => (
              <tr
                key={t.name}
                className="border-b border-[#f7f3ed] last:border-0"
              >
                ...
                <td className="py-3 text-right">
                  <span
                    className={`text-[11px] px-2.5 py-1 rounded-full ${t.status === "Admin" ? "bg-[#faf5eb] text-[#c9a84c]" : t.status === "Editor" ? "bg-[#f0ebe3] text-[#76593a]" : "bg-[#f7f3ed] text-[#a89279]"}`}
                  >
                    {t.status}
                  </span>
                </td>
      ...
      <div className="space-y-3">
        {settingsSections.map((s) => (
          <div
            key={s.label}
            className="bg-white rounded-2xl p-5 border border-[#efe9df] flex items-center gap-4 cursor-pointer hover:border-[#c9a84c] transition group"
          >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-[#efe9df]">
          ...
          <div className="bg-[#faf8f3] rounded-xl p-4">
            ...
            <div className="text-[#a89279] text-[12px] mt-1">
              Billed annually · Renewed Jan 2027
            </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#efe9df]">
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#faf8f3] rounded-xl cursor-pointer hover:bg-[#f5eedd] transition">
              <div className="text-[#341701] text-[13px]">
                Documentation & Guides
              </div>
              <div className="text-[#a89279] text-[11px]">
                Access the full MuseoVerse partner knowledge base
              </div>
            </div>
            <div className="p-3 bg-[#faf8f3] rounded-xl cursor-pointer hover:bg-[#f5eedd] transition">
              <div className="text-[#341701] text-[13px]">Contact Support</div>
              <div className="text-[#a89279] text-[11px]">
                partner-support@museoverse.com
              </div>
            </div>
            <div className="p-3 bg-[#faf8f3] rounded-xl cursor-pointer hover:bg-[#f5eedd] transition">
              <div className="text-[#341701] text-[13px]">Request Feature</div>
              <div className="text-[#a89279] text-[11px]">
                Submit ideas for the MuseoVerse platform roadmap
              </div>
            </div>
          </div>
        </div>
