import svgPaths from "./svg-fqzvnxb5t1";
...
import imgImage from "figma:asset/9daab04414367d49254977be5b6fb20e0c511e1b.png";
import imgImageBackground from "figma:asset/c3e7071cc11e0d99c54323bb10def8e079540a2a.png";
import imgMedia from "figma:asset/ca056261c8964273af437996f47e8ccb889a47fe.png";
import imgImageBackground1 from "figma:asset/4babc0d8edbc45fb13a01f5838ea3a205e476bd2.png";
import imgImage2 from "figma:asset/8c7f043987286e2460c0affda209dfd0614286b3.png";
import imgImage3 from "figma:asset/3ecab434489fedffc3c7cbf3cc16b0ca013cfeea.png";
import imgAncientGreekMarbleStatue from "figma:asset/e12978acff764c6519cf9f9ea1a9bc15e2b1ee0c.png";
    ...
    <div className="absolute bg-[#e2e8f0] content-stretch flex flex-col items-start justify-center left-[16px] overflow-clip rounded-[9999px] size-[40px] top-[16px]" data-name="Background">
      <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[117.03%] left-0 max-w-none top-[-0.07%] w-full" src={imgImage} />
        </div>
      </div>
    </div>
  );
...
function Container3() {
  return <div className="h-[13px] shrink-0 w-[53px]" data-name="Container" />;
}
  ...
  return (
    <div className="relative shrink-0 size-[12px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Group 49">
          <circle cx="6" cy="6" fill="var(--fill-0, white)" id="Thumb" r="6" />
        </g>
      </svg>
    </div>
  );
...
function Composer() {
  return (
    <div className="absolute bg-white border border-[#c9a84c] border-solid h-[127.667px] left-[16px] right-[18px] rounded-[32px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-[428px]" data-name="Composer">
      <Background1 />
      <Container1 />
    </div>
  );
...
function FeedDivider() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[16px] pb-[8px] px-[16px] right-[18px] top-[583.13px]" data-name="Feed Divider">
...
function Heading1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-[5px]" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#341701] text-[14px] w-full">
        <p className="leading-[20px]">The Metropolitan Museum of Art</p>
      </div>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute h-[10px] left-[53px] top-[3px] w-[8px]" data-name="Icon">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 10">
          <path d={svgPaths.p3eaabf80} fill="var(--fill-0, #64748B)" id="Icon" />
        </svg>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-0 not-italic text-[#64748b] text-[12px] top-[8px] w-[229px]">
        <p className="whitespace-pre-wrap">
          <span className="leading-[16px]">{`2h ago •     `}</span>
          <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic">European Paintings</span>
        </p>
      </div>
    </div>
  );
...
function Container10() {
  return (
    <div className="absolute h-[16px] left-0 right-0 top-[25px]" data-name="Container">
      <Group2 />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="-translate-y-1/2 absolute h-[46px] left-[52px] top-1/2 w-[229px]" data-name="Container">
      <Heading1 />
      <Container10 />
    </div>
  );
...
function Container8() {
  return (
    <div className="-translate-y-1/2 absolute h-[46px] left-[16px] top-1/2 w-[291px]" data-name="Container">
      <div className="-translate-y-1/2 absolute left-0 rounded-[9999px] size-[40px] top-1/2" data-name="Image+Background">
  ...
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[16px] right-[16px] top-[62.75px]" data-name="Content">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[69px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-[318px]">
        <p className="leading-[22.75px]">Unearthed these fascinating relics today; every texture whispers history. This gallery feels timeless and unforgettable. #MuseoVerse</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[24px]" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] text-center w-[35px]">
        <p className="leading-[16px]">1.2K</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[24px]" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] text-center w-[38px]">
        <p className="leading-[16px]">958</p>
      </div>
    </div>
  );
}
...
function FeedItem() {
  return (
    <div className="absolute bg-white border border-[#c9a84c] border-solid h-[447px] left-[33px] overflow-clip right-[35px] rounded-[32px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-[618px]" data-name="Feed Item 1">
      <UserInfo />
      <Content />
      <Actions />
      <Media />
  ...
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-0" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#341701] text-[14px] w-[57.08px]">
        <p className="leading-[20px]">Arian K.</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return <div className="absolute h-[16px] left-0 right-0 top-[20px]" data-name="Container" />;
}

function Container20() {
  return (
    <div className="-translate-y-1/2 absolute h-[36px] left-[52px] top-1/2 w-[131.48px]" data-name="Container">
      <Heading2 />
      <Container21 />
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-0 not-italic text-[#64748b] text-[12px] top-[8px] w-[229px]">
        <p className="leading-[16px] whitespace-pre-wrap">{`6h ago •     Musée du Louvre`}</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="absolute h-[16px] left-[52px] top-[21.88px] w-[229px]" data-name="Container">
      <Group3 />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="-translate-y-1/2 absolute h-[40px] left-[16px] top-1/2 w-[424.48px]" data-name="Container">
      <div className="-translate-y-1/2 absolute left-0 rounded-[9999px] size-[40px] top-1/2" data-name="Image+Background">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[9999px]">
          <div className="absolute bg-[#e2e8f0] inset-0 rounded-[9999px]" />
  ...
  return (
    <div className="mb-[-1.2px] relative shrink-0 w-[324px]" data-name="Content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[69px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[14px] w-full">
          <p className="leading-[22.75px]">Just explored the Louvre’s Egyptian collection today. Watching the hieroglyphs animate across the gallery walls felt absolutely unforgettable!</p>
        </div>
      </div>
    </div>
  );
...
function Background2() {
  return (
    <div className="bg-[#f1f5f9] col-1 content-stretch flex flex-col h-[192px] items-start justify-center justify-self-stretch relative row-1 shrink-0" data-name="Background">
      <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-[-25.35%] max-w-none top-[-0.14%] w-[156.62%]" src={imgImage2} />
        </div>
      </div>
    </div>
  );
...
function Background3() {
  return (
    <div className="bg-[#f1f5f9] col-2 content-stretch flex flex-col h-[192px] items-start justify-center justify-self-stretch relative row-1 shrink-0" data-name="Background">
      <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-[-25.35%] max-w-none top-[-0.14%] w-[156.62%]" src={imgImage3} />
        </div>
      </div>
    </div>
  );
...
function FeedItem1() {
  return (
    <div className="absolute bg-white left-[33px] right-[35px] rounded-[32px] top-[1092.13px]" data-name="Feed Item 2">
...
function AncientGreekMarbleStatue() {
  return (
    <div className="absolute inset-[-1px]" data-name="Ancient Greek Marble Statue">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[159.37%] left-0 max-w-none top-[-29.69%] w-full" src={imgAncientGreekMarbleStatue} />
      </div>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[24px]" data-name="Container">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffe088] text-[10px] tracking-[2px] uppercase w-[133.39px]">
        <p className="leading-[15px]">Special Exhibition</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] right-[24px] top-[47px]" data-name="Heading 2">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium h-[32px] justify-center leading-[0] relative shrink-0 text-[24px] text-white tracking-[-0.6px] w-[217.55px]">
        <p className="leading-[32px]">Global Museum Tour</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] max-w-[320px] opacity-90 pb-[0.625px] right-[24px] top-[85.88px]" data-name="Container">
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] h-[46px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdcc6] text-[14px] w-[316.89px]">
        <p className="leading-[22.75px] mb-0">Join a virtual expedition through the Renaissance</p>
        <p className="leading-[22.75px]">wings of the Uffizi and beyond.</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute bottom-[-1px] h-[156.5px] left-[-1px] w-[368px]" data-name="Container">
      <Container32 />
      <Heading />
      <Container33 />
    </div>
...
function HeroSectionGlobalMuseumTour() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] border border-[#c9a84c] border-solid h-[256px] left-[16px] overflow-clip rounded-[12px] shadow-[0px_4px_32px_0px_rgba(52,23,1,0.05)] top-[145px] w-[408px]" data-name="Hero Section: Global Museum Tour">
      <AncientGreekMarbleStatue />
      <div className="absolute bg-gradient-to-t from-[rgba(52,23,1,0.9)] inset-[-1px] to-[rgba(52,23,1,0)] via-1/2 via-[rgba(52,23,1,0.2)]" data-name="Gradient" />
      <Container31 />
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[13px] right-0 top-0 w-[27.33px]" data-name="Elements / Battery">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27.33 13">
        <g clipPath="url(#clip0_1_1931)" id="Elements / Battery">
...
function Group4() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <Indicators />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex items-center justify-center left-[calc(50%-131px)] top-[calc(50%-729px)]" data-name="Elements / Time">
...
function CompleteApplicationPrototypeCopy() {
  return (
    <div className="absolute bg-white h-[1537px] left-0 overflow-clip top-0 w-[440px]" data-name="Complete application prototype (Copy)">
      <div className="absolute flex h-[1537px] items-center justify-center left-[-134px] top-0 w-[708px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-[708px] relative w-[1537px]" data-name="image 1">
...
export default function FeedGeneral() {
  return (
    <div className="relative size-full" data-name="Feed - General">
